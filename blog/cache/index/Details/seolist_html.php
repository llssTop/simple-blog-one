...
<header>
  ...
  <a href="index.php?m=index&c=Index&a=gustbook"><span>留言版</span><span class="en">Gustbook</span></a>
  </nav>
</header>
<article class="blogs">
<h1 class="t_nav"><span>可以简单理解为提升网站自然排名、改进用户体验、提高转化率的网站优化行为</span><a href="index.php" class="n1">网站首页</a><a href="index.php?m=index&c=Index&a=seolist" class="n2">PHP技术</a></h1>
<div class="bloglist left">
   <!--wz-->
    ...
    <ul>
      ...
      <a title="阅读全文" href="index.php?m=index&c=Index&a=content" target="_blank" class="readmore">阅读全文>></a>
    </ul>
    <div class="clear"></div>
    </div>
   <!--end-->
...
<footer>
  <p><span>Design By:<a href="www.shanshantop.com" target="_blank">姗姗</a></span><span>网站地图</span><span><a href="/">网站统计</a></span></p>
</footer>
