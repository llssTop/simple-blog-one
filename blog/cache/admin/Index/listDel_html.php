...
<body>
<form method="post" action="index.php?m=admin&c=Index&a=listDel" id="listform" enctype="multipart/form-data" >
      ...
      <volist name="list" id="vo">
        ...
        <tr>
          <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="<?=$v['id']; ?>" />
           <?=$v['id']; ?></td>
          <td width="10%"><img src="<?php echo WEB_SITE;?><?=$v['picture']; ?>" alt="" width="70" height="50" /></td>
          <td><?=$v['title']; ?></td>
