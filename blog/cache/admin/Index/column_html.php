...
<div class="panel admin-panel">
  ...
  <a class="button border-yellow" href="index.php?m=admin&c=Index&a=add"><span class="icon-plus-square-o"></span> 添加内容</a>
  </div> 
  <table class="table table-hover text-center">
    ...
    <tr>
      ...
      <a type="button" class="button border-main" href="index.php?m=admin&c=Index&a=add"><span class="icon-edit"></span>修改</a>
