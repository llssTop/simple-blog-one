...
<body>
<form method="post" action="index.php?m=admin&c=Index&a=list" id="listform" enctype="multipart/form-data" >
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 内容列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="index.php?m=admin&c=Index&a=add"> 添加内容</a> </li>
      </ul>
    </div>
    <table class="table table-hover text-center">
      ...
      <volist name="list" id="vo">
        ...
        <tr>
          ...
          <td><div class="button-group"> <a class="button border-main" href="index.php?m=admin&c=Index&a=upAdd&id=<?=$v['id']; ?>"><span class="icon-edit"></span> 修改</a> <input class="button border-red" type="submit" value="放入回收站"></div></td>
        </tr>
        <?php endforeach;?>
        <?php endif;?>
      <tr>
